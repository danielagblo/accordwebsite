"""
Django settings for accordsite project.
...
SECRET_KEY = 'django-insecure-(7($)y&u9!8(3&)%l4=gjhs6^p7u@+@d(_10n&+hc5+4x-@33v'
...
WSGI_APPLICATION = 'accordsite.wsgi.application'
